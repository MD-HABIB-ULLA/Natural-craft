                  ...
                  <div className="flex flex-col md:flex-row gap-2">
                    ...
                    <div className="mb-5">
                      ...
                      <input
                        ...
                        className="border rounded-lg px-3 py-2 mt-1  w-full  text-black text-base  outline-none"
                      />
                      {errors.email && (
                  ...
                  <div className="mb-5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="border rounded-lg px-3 py-2 mt-1 w-full outline-none text-black text-base"
                      />
                      <span
              ...
              <div className="flex justify-center items-center mt-5">
                <div>
                  ...
                  >
                    ...
                    <span className="md:ml-8 ml-3 md:">
                      Sign in with Google
                    </span>
                  </button>
                  <button
