                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between font-bold">
                      <p className="flex gap-1 items-center"><BsCashCoin className="text-green-600"/> Price: {singleCraftItem.price} tk </p>
                      <p className="flex gap-1 items-center" ><FaStar  className="text-orange-400"/>Ratin: {singleCraftItem.rating} </p>
                    </div>
