    ...
    fetch("http://localhost:4000/craftItems", {
        ...
        .then((data) => {
          if (data.acknowledged) {
            toast.success("Carft Item successfully  added!");
            form.reset();
          }
        });
  };
  return (
    <div>
      {loading ? (
        ...
        >
          <form className="  md:px-10 pb-10 px-3  dark:bg-[#1a111142] bg-[#251c1a2f] duration-500 mx-8 md:mx-0 shadow rounded-3xl  border-[#322C2B] dark:border-[#E4C59E] border-2">
...
// NaturealCraft 5MWQGg8rpkq4yWba
